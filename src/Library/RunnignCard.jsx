     ...
     <div data-aos="fade-down" className="flex justify-center items-center">
      ...
      >
        ...
        <div className="absolute top-4 left-4 z-10">
          <div className="">
            <img src='https://floka.casethemes.net/wp-content/uploads/2025/05/home-1-icon4.svg' alt=""  className="w-28"/>
          </div>
        </div>
        ...
        >
          <h3 className="text-lg font-semibold uppercase">Branding, Product, ux</h3>
        </div>
      </div>
    </div>
  );
