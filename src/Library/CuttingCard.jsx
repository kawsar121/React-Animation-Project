...
import cuttingimg from '../assets/cutting.jpeg'
import Aos from "aos";
...
const CuttingCard = () => {
  ...
  const handleMouseLeave = () => {
    ...
    return (
     <div data-aos="fade-down" className="flex justify-center items-center h-screen  max-w-7xl mx-auto rounded-3xl">
      <div
        ref={cardRef}
        onMouseMove={handleMouseMove}
        onMouseEnter={() => setHovered(true)}
        onMouseLeave={handleMouseLeave}
        className="relative w-[90%] md:w-[100%] h-[80%] md:h-[100%] overflow-hidden rounded-2xl shadow-xl cursor-pointer group"
      >
        {/* Image */}
        <img
          src={cuttingimg}
        ...
        <div className="absolute top-4 left-4 z-10">
          <div className="">
            <img src="https://floka.casethemes.net/wp-content/uploads/2025/05/home-1-icon5.svg" alt=""  className="w-28"/>
          </div>
        </div>
        ...
        >
          <h3 className="text-lg font-semibold uppercase">Branding Ux</h3>
        </div>
      </div>
    </div>
    );
